...
| **GES RAG (pilot)** | Static pilot objectives + **keyword retrieval** (no vector DB yet); model must cite allowlisted IDs; **Verified** badge when ID was in retrieved set. | [`src/data/gesCurriculumPilot.ts`](../../src/data/gesCurriculumPilot.ts), [`src/services/curriculumRagService.ts`](../../src/services/curriculumRagService.ts), [`src/services/aiPrompts.ts`](../../src/services/aiPrompts.ts), [`AnalysisResults.tsx`](../../src/components/AnalysisResults.tsx) |
