...
| **2. HeckTeck Connect MVP** | AI weekly digest (English) + translation to guardian language; copy + **demo queue** to Firestore. | [`aiPrompts.ts`](../../src/services/aiPrompts.ts) (`generateWeeklyParentDigestEnglish`, `translateParentDigest`), [`parentDigestService.ts`](../../src/services/parentDigestService.ts), [`Phase4FamilyConnectCard.tsx`](../../src/components/Phase4FamilyConnectCard.tsx) |
