...
| ----- | ------------- | --------- |
| **Foundations** | Student org fields + defaults; `users` doc may include `districtId`, `circuitId`, `schoolId`; dashboard rollups from Firestore; RBAC-driven tabs. | [`organizationDefaults.ts`](../../src/config/organizationDefaults.ts), [`enterpriseAnalyticsService.ts`](../../src/services/enterpriseAnalyticsService.ts), [`enterpriseAccess.ts`](../../src/auth/enterpriseAccess.ts), [`App.tsx`](../../src/App.tsx) |
