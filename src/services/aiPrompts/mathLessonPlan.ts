...
=== TASK ===
Produce ONE new 5-minute remedial lesson plan for the mathematics gap above. Ground remediation in Cambridge-aligned progression for Grades 1–9 at studentGradeLevel ${grade}. Follow CPA explicitly, include at least one TWM strand with a clear teacher prompt, respect the age band for concrete materials, and comply with translanguaging rules if a dialect was specified.
